                                    ...
                                    {searchQuery.length === 0 ? (
                                        <div className="quick-links-section">
                                            ...
                                            <div className="ql-grid">
                                                ...
                                                <div className="ql-item" onClick={() => handleSearchResultClick('#/payroll/employee-ctc')}>
                                                    <div className="ql-icon green"><DollarSign size={18} /></div>
                                                    <span>Payroll</span>
                                                </div>
                                                <div className="ql-item" onClick={() => handleSearchResultClick('#/dashboard')}>
                                                    <div className="ql-icon purple"><Users size={18} /></div>
                                                    <span>Employees</span>
                                                </div>
                                                <div className="ql-item" onClick={() => handleSearchResultClick('#/company-settings/branches')}>
