...
export const assignShift = async (req, res) => {
    try {
        ...
        const assignments = await Promise.all(employeeIds.map((empId) => db.shiftAssignment.upsert({
            where: {
...
export const getRotations = async (_req, res) => {
    try {
...
// ─── SHIFT STATS / REPORTS ────────────────────────────────────────────────────
export const getShiftStats = async (_req, res) => {
    try {
...
export const getShiftChangeRequests = async (_req, res) => {
    try {
...
export const getPenaltyRules = async (_req, res) => {
    try {
