        ...
        <div className="page-container">
            <div className="page-header">
                ...
                <div className="flex gap-2">
                    <button className={`px-4 py-2 rounded-lg text-sm font-medium ${view === 'groups' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`} onClick={() => {setView("groups"); setShowForm(false);}}>
                        <Layers size={16} className="inline mr-1"/> Manage Groups
                    </button>
                    <button className={`px-4 py-2 rounded-lg text-sm font-medium ${view === 'assign' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`} onClick={() => setView("assign")}>
                        <Users size={16} className="inline mr-1"/> Assign to Employees
                    </button>
                </div>
            </div>
